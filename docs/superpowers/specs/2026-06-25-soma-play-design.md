...
6. **Controle de rolagem automática** flutuante (play/pause + velocidade **1–5**), com auto-ocultar por inatividade. A escala nasceu linear de 1 a 10 e começava rápido demais — o nível 1 já corria a ~23 px/s. Desde 2026-08-06 são **cinco níveis geométricos** (`js/scroll-speed.js`), cada um cerca do dobro do anterior: ~12 · 23 · 47 · 93 · 233 px/s. O piso é metade do antigo nível 1 e o teto é o antigo nível 10 — a resolução fica embaixo, onde de fato se toca.
