...
fonte por vez** e **não persiste entre sessões**. Aquele spec ganhou uma nota apontando
para cá; o resto dele — alcance global, listas imunes, comparação por grafia normalizada,
o sentinela `SEM_FONTE` — continua valendo palavra por palavra.
